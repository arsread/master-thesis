...
% 英文封面内容(关注内容而不是表现形式)
\englishtitle{The Construction and Optimization of a Java Parallelization Framework Based on Dynamically Bytecode Generation}
