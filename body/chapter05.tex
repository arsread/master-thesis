...
\begin{table}[htbp]
	\centering
	\bicaption[tab:tab2]{检查点数据的实验结果}{检查点数据的实验结果}{Table}{The test result of CheckPoint}
...
\begin{table}[htbp]
	\centering
	\bicaption[tab:tab3]{检查点数据的实验结果}{检查点数据的实验结果}{Table}{The test result of CheckPoint}
	\begin{tabular}{c|c|c|c}
		\hline
		测试用例 & 原程序 & 锁优化 & 返回值 \\
		\hline
